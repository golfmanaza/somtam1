...
<div class="w3-top ">
  <div class="w3-bar w3-white w3-padding w3-card-2 w3-hide-small w3-" style="letter-spacing:3px;">
     <h1><a href="https://golfmanaza.github.io/10yummyfoodinHDY/" target="_blank" class=" w3-hover-text-green">10ร้านห้ามพลาดในหาดใหญ่</a></h1>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px" id="home">
  ...
  <div class="w3-display-middle w3-padding-large w3-black">
    <h1 class="w3-xlarge w3-animate-left w3-card-4">"ร้านส้มตำกระรอก" </h1>
  </div>
</header>
...
<div class="w3-display-container mySlides"> 
  <img src="somtam4.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">
  </div>
